...
\include{pages/03related_work}
\include{pages/04design_overview}
\include{pages/05hardware}
\include{pages/06chain_for_air_quality}
\include{pages/07machine_learning}
\include{pages/08conclusions_and_future_work}

\appendix
\include{pages/XX_appa}
\include{pages/XX_appb}
\include{pages/XX_appc}
\include{pages/XX_appd}
